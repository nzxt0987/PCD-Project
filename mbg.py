...
class ColorSpaceApp:
    ...
    def create_overview_page(self):
        ...
        source_actions.grid_columnconfigure(1, weight=0)
    ...
    def create_transform_page(self):
        ...
        image_button_frame.grid_columnconfigure(1, weight=0)
    ...
    def preview_adjustment(self, value=None):
        ...
        if hasattr(self, "result_mode_label"):
            mode_text = self.overview_mode_combo.get() if hasattr(self, "overview_mode_combo") else "Preview"
    ...
    def apply_adjustment(self):
        ...
        if hasattr(self, "result_mode_label"):
            mode_text = self.overview_mode_combo.get() if hasattr(self, "overview_mode_combo") else "Image"
            self.result_mode_label.configure(
    ...
    def reset_adjustment(self):
        ...
        if hasattr(self, "result_mode_label"):
            mode_text = self.overview_mode_combo.get() if hasattr(self, "overview_mode_combo") else "Original"
            self.result_mode_label.configure(
    ...
    def convert_color(self, event=None):
        ...
        if isinstance(event, str) and event in modes:
            mode = event
        elif hasattr(self, "overview_mode_combo"):
